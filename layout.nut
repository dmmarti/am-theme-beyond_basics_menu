...
//adjust the values below for the static preview video snap
   ...
   local snapbg=null;
   snapbg = fe.add_image( "static.mp4", flx*0.0466, fly*0.376, flw*0.405, flh*0.538 );
 ...
 {
 local temp = fe.add_image( "static.png", flx*0.0466, fly*0.376, flw*0.405, flh*0.538);
 }
...
surface_snap.set_pos(flx*0.0466, fly*0.376, flw*0.53, flh*0.538);
...
//Title text info
local textt = fe.add_text( "[Title]", flx*0.04, fly*0.942, flw*0.6, flh*0.025  );
...
//Emulator text info
local textemu = fe.add_text( "[DisplayName]", flx* 0.04, fly*0.967, flw*0.6, flh*0.025  );
...
//category icons 
local glogo1 = fe.add_image("glogos/unknown1.png", flx*0.155, fly*0.945, flw*0.033, flh*0.05);
...
{
if ( wheel_fade_ms > 0 && ( my_config["enable_list_type"] == "curved") )
{
